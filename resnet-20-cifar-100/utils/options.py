...
LL_METHOD = 'ours' # original, ecw
#CB_METHOD = 'cb' # else (no balance)
...
#parser.add_argument('--data_dir', type = str, default = '/media/ta/e9cf3417-0c3e-4e6a-b63c-4401fabeabc8/ta/cifar100/', help = 'The directory where the input data is stored.')
parser.add_argument('--data_dir', type = str, default = '/media/disk3/tachen/datasets/cifar100/', help = 'The directory where the input data is stored.')
#parser.add_argument('--data_dir', type = str, default = '/home/tachen/dataset/cifar100/', help = 'The directory where the input data is stored.')
...
parser.add_argument('--csv_dir', type = str, default = 'data/cifar100_025/', help = 'The directory where the input data is stored.')
...
parser.add_argument('--num_epochs', type = int, default = 30, help = 'The num of epochs to train.') # 30
# 1. train: default = 100
...
parser.add_argument('--lr', type = float, default = 0.01) # ours: 0.005, ecw: 0.01, mas: smaller, scp: 0.01
#parser.add_argument('--lr2', type = float, default = 1e-2, help='learning rate (default: 0.001)')# 1. train: default = 0.01
...
#parser.add_argument('--recover_lambda', type = float, default = 0.3) # ours: 130,200, ecw: 100, mas: smaller, scp: 0.01
#parser.add_argument('--sparse_lambda', type = float, default = 0.2) # ours: 130,200, ecw: 100, mas: smaller, scp: 0.01

parser.add_argument('--lr_decay_step', type = int, default = 30)
parser.add_argument('--lr_decay_steps', type = list, default = [10, 20])
# 1. train: default = 30
