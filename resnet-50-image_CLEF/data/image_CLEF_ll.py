...
class Data:
    def __init__(self, args, task_id):
        ...
        for i in range(task_id+1):
            ...
            trainset = image_CLEF_LL(args=args, root=args.csv_dir, train='train', 
            ...
            replayset = image_CLEF_LL(args=args, root=args.csv_dir, train='replay', 
                                  transform=transform_train, task_id=i)
            ...
            testset = image_CLEF_LL(args=args, root=args.csv_dir, train='test', 
