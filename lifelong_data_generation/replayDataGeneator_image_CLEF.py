...
parser.add_argument('--data_dir', type = str, default = 'image_CLEF_02/', help = 'Data directory')
parser.add_argument('--data_csv', type = str, default = 'image_CLEF_02.csv', help = 'Output csv')
