...
from .quantization_alignq import *
...
class ResNet(nn.Module):
    ...
    def __init__(self, wbit, abit, stage, block, layers, num_classes=args.num_classes, zero_init_residual=False,
    ...
    def _forward_impl(self, x):
        ...
        x = self.avgpool(x)
        self.feature = torch.flatten(x, 1).to(device)
...
def resnet18_quant(bitW, abitW, stage, pretrained=True, progress=True, **kwargs):
    return _resnet(bitW, abitW, stage, 'resnet18', BasicBlock, [2, 2, 2, 2], pretrained, progress, **kwargs)

def resnet34_quant(bitW, abitW, stage, pretrained=True, progress=True, **kwargs):
    return _resnet(bitW, abitW, stage, 'resnet34', BasicBlock, [3, 4, 6, 3], pretrained, progress, **kwargs)

def resnet50_quant(bitW, abitW, stage, pretrained=True, progress=True, **kwargs):
  return _resnet(bitW, abitW, stage, 'resnet50', Bottleneck, [3, 4, 6, 3], pretrained, progress, **kwargs)
