...
parser.add_argument('--dataset', type = str, default = 'image_CLEF', help = 'Dataset to train')

#parser.add_argument('--data_dir', type = str, default = '/media/ta/e9cf3417-0c3e-4e6a-b63c-4401fabeabc8/ta/image_CLEF_split', help = 'The directory where the input data is stored.')
#parser.add_argument('--data_dir', type = str, default = '/media/disk3/tachen/datasets/image_CLEF_split/', help = 'The directory where the input data is stored.')
parser.add_argument('--data_dir', type = str, default = '/home/tachen/dataset/image_CLEF_split/', help = 'The directory where the input data is stored.')
...
parser.add_argument('--csv_dir', type = str, default = 'data/image_CLEF_01/', help = 'The directory where the input data is stored.')
...
parser.add_argument('--target_model', type = str, default = 'mobile_v2_quant', help = 'The target model.')
...
## Status
parser.add_argument('--print_freq', type = int, default = 8, help = 'The frequency to print loss.')
